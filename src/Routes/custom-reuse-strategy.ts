...
export class CustomReuseStrategy implements RouteReuseStrategy {
    ...
    shouldDetach(route: ActivatedRouteSnapshot): boolean {
        // per il momento salvo sempre tutto, poi nel caso si può prevedere che se la lista dei componenti salvati supera un tot di memoria, si sovrascrive l'ultimo
